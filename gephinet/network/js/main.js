var groupNames = ['Germany','United States','Spain','Australia','Canada','China','Italy','Turkey','New Zealand','Israel','United Kingdom','France','Austria','Netherlands','Switzerland','South Korea','Belgium','Singapore','Japan','Greece','India','Norway','Denmark','Chile','Taiwan','Sweden','Brazil','Ireland'];
...
function configSigmaElements(config) {
    ...
    $GP.bg2 = $(sigInst._core.domElements.bg2);
     var a = [],
        b,x=0;
        for (b in sigInst.clusters) a.push('<div style="line-height:12px"><a href="#' + b + '"><div style="width:40px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div> ' + groupNames[x++] + ' (' + sigInst.clusters[b].length +')</a></div>');

a.splice(0, 0, a.splice(3, 1)[0]);
a.splice(1, 0, a.splice(12, 1)[0]);
a.splice(2, 0, a.splice(16, 1)[0]);
a.splice(3, 0, a.splice(26, 1)[0]);
a.splice(4, 0, a.splice(7, 1)[0]);
a.splice(5, 0, a.splice(24, 1)[0]);		
a.splice(6, 0, a.splice(9, 1)[0]);
a.splice(7, 0, a.splice(24, 1)[0]);
a.splice(8, 0, a.splice(16, 1)[0]);
a.splice(10, 0, a.splice(22, 1)[0]);
a.splice(11, 0, a.splice(23, 1)[0]);
a.splice(12, 0, a.splice(27, 1)[0]);
a.splice(13, 0, a.splice(18, 1)[0]);
a.splice(14, 0, a.splice(16, 1)[0]);
a.splice(15, 0, a.splice(24, 1)[0]);
a.splice(16, 0, a.splice(21, 1)[0]);
a.splice(17, 0, a.splice(20, 1)[0]);
a.splice(18, 0, a.splice(25, 1)[0]);
a.splice(19, 0, a.splice(25, 1)[0]);
a.splice(20, 0, a.splice(25, 1)[0]);
a.splice(21, 0, a.splice(22, 1)[0]);
a.splice(22, 0, a.splice(27, 1)[0]);
a.splice(23, 0, a.splice(26, 1)[0]);
a.splice(24, 0, a.splice(27, 1)[0]);
a.splice(25, 0, a.splice(26, 1)[0]);
a.splice(26, 0, a.splice(27, 1)[0]);
	//var a = [],
     //   b,x=1;
